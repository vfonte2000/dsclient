...
public class ClientService {
	...
	public ClientDTO findById(Long id) {
		...
		Client entity = obj.orElseThrow(() -> new ResourcerNotFoundException("Entity not found"));
	...
	public ClientDTO update(Long id, ClientDTO dto) {
		try {
			...
			throw new ResourcerNotFoundException("in not found valcelio teste " + id);
	...
	public void delete(Long id) {
		try {
			...
			throw new ResourcerNotFoundException("id not found" + id);

		}

		catch (DataIntegrityViolationException e) {
			throw new DatabaseException("Integrity violation Valcelio delete ");
